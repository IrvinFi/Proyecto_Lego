...
void reja_torre(){
	...
	glPushMatrix();
		glScalef(10, 1, 1);
		glDisable(GL_COLOR_MATERIAL);
		fig10.prisma2(azul_torre.GLindex, azul_torre.GLindex); 
		glEnable(GL_COLOR_MATERIAL);
	glPopMatrix();
	glTranslatef(0,3.25,1);
	glPushMatrix();
		glScalef(10, 1, 3);
		glDisable(GL_COLOR_MATERIAL);
		fig10.prisma2(azul_torre.GLindex, azul_torre.GLindex); 
...
void torre() {
	...
	glEnable(GL_LIGHTING);
	glPopMatrix();
	glTranslatef(0, 0, -2.75); //arbustos
	glPushMatrix();
	glScalef(2, 2, 3.5);
	glDisable(GL_LIGHTING);
	fig3.prisma2(superior.GLindex, lateral.GLindex);
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(-2, -7.25, 0);
		glPushMatrix();
			glScalef(1, 13.5, 8);
			glDisable(GL_COLOR_MATERIAL);
			fig10.prisma2(door_school.GLindex, door_school.GLindex);
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
	glPopMatrix();

	glPushMatrix();
		glTranslatef(17.3,-7.25,0);
		glPushMatrix();
			glScalef(8,.5,8);
			glDisable(GL_LIGHTING);
			fig10.prisma2(banqueta.GLindex,banqueta.GLindex);
			glEnable(GL_LIGHTING);
		glPopMatrix();
		glTranslatef(8, 0, 0);
		glPushMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 1
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		...
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 2
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(0, -7.5, 3);
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 3
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(0, -7.5, -3);
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 4
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(0, -7.5, 3);
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 5
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(0, -7.5, -3);
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(1.5, 1.5, 1000, gris.GLindex); //cilindro 6
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(2.5, 1.5, 1000, gris.GLindex); //cilindro 1
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(0, 0, -10);
		glPushMatrix();
			glRotatef(-90, 0, 0, 1);
			glDisable(GL_COLOR_MATERIAL);
			fig10.cilindro(2.5, 1.5, 1000, gris.GLindex); //cilindro 2
			glEnable(GL_COLOR_MATERIAL);
		glPopMatrix();
		glTranslatef(-5, 0, -5);
		glPushMatrix();
	...
	glPushMatrix();
		...
		glPushMatrix();
			...
			glPushMatrix();
				glRotatef(-90, 1, 0, 0);
				glDisable(GL_COLOR_MATERIAL);
				fig10.cilindro(2.5, 1.5, 1000, gris.GLindex);//cilindro 3
				glEnable(GL_COLOR_MATERIAL);
			glPopMatrix();
		glPopMatrix();
		glTranslatef(0, -7.5, 0);
		glPushMatrix();
			...
			glPushMatrix();
				glRotatef(-90, 1, 0, 0);
				glDisable(GL_COLOR_MATERIAL);
				fig10.cilindro(2.5, 1.5, 1000, gris.GLindex); //cilindro 4
				glEnable(GL_COLOR_MATERIAL);
			glPopMatrix();
		glPopMatrix();
		glTranslatef(-10, 0, 0);
		glPushMatrix();
			...
			glPushMatrix();
				glRotatef(-90, 1, 0, 0);
				glDisable(GL_COLOR_MATERIAL);
				fig10.cilindro(2.5, 1.5, 1000, gris.GLindex); //cilindro 5
				glEnable(GL_COLOR_MATERIAL);
			glPopMatrix();
		glPopMatrix();
		glTranslatef(0, 7.5, 0);
		glPushMatrix();
			...
			glPushMatrix();
				glRotatef(-90, 1, 0, 0);
				glDisable(GL_COLOR_MATERIAL);
				fig10.cilindro(2.5, 1.5, 1000, gris.GLindex); //cilindro 6
				glEnable(GL_COLOR_MATERIAL);
			glPopMatrix();
		glPopMatrix();
		glTranslatef(-5, 0, 5);
