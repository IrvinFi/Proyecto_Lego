...
void CFiguras::prisma4(GLuint text, GLuint text2)  //Funcion creacion prisma
{
...
void CFiguras::prisma_anun(GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[7]);*/
	glTexCoord2f(text_der + 1.0, 0.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(text_der + 1.0, 1.0f); glVertex3fv(vertice[5]);
